...
\makebox[0pt][t]{%
	\raisebox{3.7em}[0pt][0pt]{%
		\includegraphics[width=5cm]{_logo}}}
}
%
%----------------------------------------------------------------------------------------
...
%----------------------------------------------------------------------------------------
%
{\vspace*{2.1em} \\ \huge{Comparison of Linear State Signal Shaping Model Predictive Control \\ with Classical Concepts for Active Power Filter Design}} % Poster title
{\vspace{.4em} \smaller\textbf{Kathrin Weihe\textsuperscript{1,2}, Carlos Cateriano Y\'a\~nez\textsuperscript{1,2}, Georg Pangalos\textsuperscript{1}, and Gerwald Lichtenberg\textsuperscript{2}}  \\  % Author names
  
\vspace{.4em}\normalsize{\textsuperscript{1}Fraunhofer ISIT, Application Center Power Electronics for Renewable Energy Systems, Steindamm 94, 20099 Hamburg \\
\textsuperscript{2}Hamburg University of Applied Sciences, Faculty Life Sciences, Ulmenliet 20, 21033 Hamburg} \\ \normalsize{\vspace{.3em}{\{kathrin.weihe, carlos.cateriano.yanez, georg.pangalos\}@isit.fraunhofer.de, gerwald.lichtenberg@haw-hamburg.de}}  } % Author email addresses
{% Conference Logo
\makebox[0pt][t]{%
	\raisebox{4em}[0pt][0pt]{%
	\hspace*{-15.5cm}
	{\begin{tabular}{m{9.6cm} m{7cm}}
		\vspace{-1cm} \includegraphics[width=7.5cm]{Simultech_logo} &
		\vspace{-1cm} \includegraphics[width=5.5cm]{HAW_logo}
	\end{tabular}}}}
}
...
\item A new model predictive control approach which uses shape classes (LSSS MPC) could be utilized to compensate harmonics without the need to design filters for different load scenarios
\end{itemize}
\vspace{-1.3em}
}}
...
\textbf{
\begin{itemize}[itemsep=0pt]
\item Could the novel LSSS MPC control approach improve the overall grid quality compared to a standard IRP APF controller?
\item Solution: Evaluate simulations with both controller types under different load scenarios
\end{itemize}}
\vspace{-1.2em}
}
