...
\vspace{-.7em}
\textbf{A novel approach: \enquote{Linear State Signal Shaping Model Predictive Control} (LS\textsuperscript{3}MPC), to compensate harmonics using shape classes has been developed}
\textbf{
\begin{itemize}[itemsep=0pt]
\item Could the LS\textsuperscript{3}MPC improve the grid quality compared to a classic APF controller?
\item Could the LS\textsuperscript{3}MPC adapt under variable load scenarios?
\end{itemize}}
\vspace{-1.2em}
}
...
\vspace{-.7em}
\textbf{A state-of-the-art classic APF controller to compensate harmonics relies on the instantaneous reactive power (IRP) theory}
