...
\vspace{-.3em}
\begin{equation*}
\frac{\text{d}^2x(t)^2}{\text{d}t^2} + \omega^2 x(t) = 0
\end{equation*}
%\vspace{.1em}
...
\vspace{-.2em}
\begin{flushleft}
\textbf{Linear state space model of one phase} \end{flushleft}
\vspace{-.7em}
...
\begin{array}{rcl}u(t)&=& i_{c0}\in \mathbb{R}\\
d(t)&=& \begin{pmatrix}v_s & i_{l0} 
