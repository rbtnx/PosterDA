...
\item A state-of-the-art method to compensate harmonics relies on the instantaneous reference frame (IRP) theory
...
\textbf{
\begin{itemize}[itemsep=0pt]
\item The LS\textsuperscript{3}MPC approach has the potential to successfully control an APF
...
\item The LS\textsuperscript{3}MPC is capable of adapting to a wider variety of load scenarios
\end{itemize}}
\vspace{-1.0em}
}
